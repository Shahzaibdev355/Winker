...
<link rel="manifest" href="/site.webmanifest">
    ...
    <title>
      Winker Same Day Tenant Verification Checks
    </title>
    <link
      rel="shortcut icon"
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            <div class="text-center">
              <h1 class="font-semibold text-white text-4xl">Tenant Verification Checks</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              >
                ...
                >
                  ...
                  <h2
                    ...
                    "
                  >
                    Winker cuts costs & delays not corners 
                  </h2>
                  <p class="text-base text-body-color mb-9 leading-relaxed">
                    AI Tech Complements Experienced Risk Analysts
                  </p>
                  <p class="text-base text-body-color mb-9 leading-relaxed">
                    Gone are the days of a landlord or agent's sole reliance on manual referencing & credit checks. Whilst this has a place within the application journey, this methodology alone does not guarantee efficient or effective vetting without additional access to advanced tech based authentication intelligence. In truth, traditional referencing can often result in higher costs, longer delays & lower or inadequate diligence.<br>
                    <p>Winker exploits the power of a computer science led in house tech team and experienced risk analysts to deliver what is being described as the game changing personnel authentication tool!<br></p>
                    
                        <p class="text-base text-body-color mb-9 leading-relaxed">
                     <p>Built from the ground up to streamline the application & risk process, Winker's system blends groundbreaking technology such as Open Banking & instant ID authentication with a bespoke, rapid data pipe system to automate events & assess risk in one transaction. </p>
                     
                        <p class="text-base text-body-color mb-9 leading-relaxed">
                     Besides lower costs & faster processing, additional benefits include the UK's first tenant smart card (WinkerID) which locks down each tenant's personal data whilst still facilitating authentication within seconds. <br>The peace of mind & security that results from owners and landlords realising that their prospect has been the subject of one of the most stringent authentication checks within the industry makes Winker a no brainer for professionals & landlords alike!
                  </p>
                  <a
                    href="signup.asp"
                    class="
...
<%else%>
                  ...
                  <h2
                    ...
                    "
                  >
                    Game changing same day risk analysis.
                  </h2>
                  <p class="text-base text-body-color mb-9 leading-relaxed">
                    Tenant referencing is generally old hat! 
                  </p>
                  <p class="text-base text-body-color mb-9 leading-relaxed">
                    That is to say that today's fast moving property pros & landlords can no longer 
                    afford to wait days for results! Neither can they afford to accept risky or fraudulent 
                    tenants in these turbulent times. This is where Winker delivers the best of both worlds!
                  </p>
                  <a
                    href="tenantverification.asp?page=2"
                    class="
                      inline-flex
                      items-center
                      justify-center
          ...
          <div class="w-full px-4">
            <div class="text-center mx-auto mb-[60px] max-w-[620px]">
              ...
              <p
                ...
                "
              >
                By adopting cutting edge technologies including Open Banking, ID Authentication, AI & Data Capture APIs Winker is faster & delivers maximum accuracy.<br>
                More speed, more insight...Less risk!
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap justify-center -mx-4">
            ...
            <div class="mb-10 wow fadeInUp" data-wow-delay=".1s">
              ...
              <div class="text-center">
                ...
                <p class="font-medium text-sm text-body-color mb-5">
                  Full 6 year credit search<br>
                  ID Authentication<br>
                  Right To Rent Verification<br>
                  Device or email delivery within 60 minutes<br>
                  24/7 online secure storage & access<br>
                  Volume discount rates<p><br>
                     <br>  <a
                    href="javascript:void(0)"
                    class="
                      inline-flex
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".15s">
              ...
              <div class="text-center">
                <h4 class="font-medium text-lg text-dark mb-2">UK Tenant Insight</h4>
                <p class="font-medium text-sm text-body-color mb-5">
                      Full 6 year credit search<br>
                  ID, KYC & Bank Authentication<br>
                Right To Rent Verification<br>
                  Provisional approval within 60 minutes<br>
                  Same day device or email delivery**<br>
                  Credit score<br>
                  Open Banking income & rental payment verification<br>
                  Manual income & rental reference authentication<br>
                  Fraud, reputation & criminal profile search<br>
                  24/7 online secure storage & access<br>
                  Volume discount rates<br>
                  **Submit before 12 noon Mon-Fri
                     <br>  <p><br><a
                    href="javascript:void(0)"
                    class="
                      inline-flex
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="text-center">
                <h4 class="font-medium text-lg text-dark mb-2">
                  Overseas Tenant Insight
                </h4>
                <p class="font-medium text-sm text-body-color mb-5">
                  Full 6 year international credit search<br>
                  ID, IAML & Bank Authentication<br>
                  Right To Rent Verification<br>
                  Credit score<br>
                  48 hour device or email delivery<br>
                  Open Banking income & rental payment verification<br>
                  Manual income & rental reference authentication<br>
                  Fraud, reputation & criminal profile search<br>
                  24/7 online secure storage & access<br>
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".25s">
              ...
              <div class="text-center">
                <h4 class="font-medium text-lg text-dark mb-2">
                  UK Commercial Insight
                </h4>
                <p class="font-medium text-sm text-body-color mb-5">
               <p class="font-medium text-sm text-body-color mb-5">
                  Full 6 year credit search<br>
                  Director/Principal credit & KYC<br>
                  Invoice payment history<br>
                  Accounts analysis<br>
                  Credit score<br>
                  Same day device or email delivery**<br>
                  Open Banking income & rental payment verification<br>
                  Manual accountant & rental reference authentication<br>
                  24/7 online secure storage & access<br>
                  Volume discount rates<br>
                  **Submit before noon Mon-Fri
