...
<h2>Send Your Prospective Tenant A Digital Application</h3>
...
<div class="fsSection fs2Col" id="fsSection124564890">
<div class="fsSectionHeader">
</div>
<div id="fsRow4795043-2" class="fsRow fsFieldRow">
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsSpan50" id="fsCell124564891" aria-describedby="fsSupporting124564891" lang="en" fs-field-type="select" fs-field-validation-name="Application Type">
<label id="label124564891" class="fsLabel fsRequiredLabel" for="field124564891">Application Type<span class="fsRequiredMarker">*</span>                                                    </label>
<select id="field124564891" name="field124564891" size="1"required class="fsField fsRequired" aria-required="true">
<option value="UK Tenant Insight">UK Tenant Insight</option>
<option value="Overseas Tenant Insight">Overseas Tenant Insight</option>
<option value="UK Company Insight">UK Company Insight</option>
<option value="UK Guarantor Insight">UK Guarantor Insight</option>
<option value="Overseas Guarantor Insight">Overseas Guarantor Insight</option>
<option value="UK Credit+">UK Credit+</option>
<option value="Overseas Credit+">Overseas Credit+</option>
</select>
<div id="fsSupporting124564891" class="fsSupporting">Select the report type that you wish to order</div>
</div>
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsSpan50" id="fsCell124564892" aria-describedby="fsSupporting124564892" lang="en" fs-field-type="select" fs-field-validation-name="Number of applicants requiring forms?">
...
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsSpan50" id="fsCell124564893" lang="en" fs-field-type="address" fs-field-validation-name="Rental Property Address ">
<span id="label124564893" class="fsLabel fsRequiredLabel">Rental Property Address <span class="fsRequiredMarker">*</span></span>
<div class="fsSubFieldGroup">
<div class="fsSubField fsFieldAddress">
<input type="text" id="field124564893-address" aria-label="Address Line 1" name="field124564893-address" size="50" value="" required class="fsField fsFieldAddress fsRequired" aria-required="true" />
<label class="fsSupporting" for="field124564893-address">Address Line 1</label>
</div>
<div class="fsSubField fsFieldAddress2">
<input type="text" id="field124564893-address2" aria-label="Address Line 2" name="field124564893-address2" size="50" value="" class="fsField fsFieldAddress2" />
<label class="fsSupporting" for="field124564893-address2">Address Line 2</label>
</div>
<div class="fsSubField fsFieldCity">
<input type="text" id="field124564893-city" name="field124564893-city" size="15" aria-label="City" value="" required class="fsField fsFieldCity fsRequired" aria-required="true" />
<label class="fsSupporting" for="field124564893-city">City</label>
</div>
<div class="fsSubField fsFieldZip">
<input type="text" id="field124564893-zip" aria-label="Postcode" name="field124564893-zip" size="8" value="" required class="fsField fsFieldZip fsFormatZipUK fsRequired" aria-required="true" />
<label class="fsSupporting" for="field124564893-zip">Postcode</label>
</div>
</div>
<div class="clear"></div>
</div>
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsSpan50" id="fsCell124569646" aria-describedby="fsSupporting124569646" lang="en" fs-field-type="select" fs-field-validation-name="Send form to mobile or email?">
...
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsHidden fsSpan50" id="fsCell124564895" lang="en" fs-field-type="email" fs-field-validation-name="First Applicant's Email Address">
...
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsHidden fsSpan50" id="fsCell124569696" lang="en" fs-field-type="phone" fs-field-validation-name="First Applicant 's Mobile Number">
...
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsHidden fsSpan50" id="fsCell124564897" lang="en" fs-field-type="email" fs-field-validation-name="Second Applicant's Email Address">
...
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsHidden fsSpan50" id="fsCell124569729" lang="en" fs-field-type="phone" fs-field-validation-name="Second Applicant 's Mobile Number">
...
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsHidden fsSpan50" id="fsCell124569730" lang="en" fs-field-type="email" fs-field-validation-name="Third Applicant's Email Address">
...
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsHidden fsSpan50" id="fsCell124569731" lang="en" fs-field-type="phone" fs-field-validation-name="Third Applicant 's Mobile Number">
...
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsHidden fsSpan50" id="fsCell124569735" lang="en" fs-field-type="phone" fs-field-validation-name="Fourth Applicant 's Mobile Number">
...
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsHidden fsSpan50" id="fsCell124569734" lang="en" fs-field-type="email" fs-field-validation-name="Fourth Applicant's Email Address ">
...
<div class="fsRowBody fsCell fsFieldCell fsFirst fsLabelVertical fsHidden fsSpan50 fsHiddenByFieldSetting" id="fsCell124568963" lang="en" fs-field-type="text" fs-field-validation-name="Username">
...
<div class="fsRowBody fsCell fsFieldCell fsLast fsLabelVertical fsSpan50" id="fsCell124564937" lang="en" fs-field-type="embed" fs-field-validation-name="">
...
form4795043.logicFields = ['124564892','124569646'];
            ...
            <div class="container">
                ...
                <div class="header4-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <img src="images/icon/3.jpg"width="200" alt="Winker" />
                        </a>
                    </div>
                            ...
                            <aside class="menu-sidebar3 js-spe-sidebar">
                                <nav class="navbar-sidebar2 navbar-sidebar3">
                                    <ul class="list-unstyled navbar__list">
                                        ...
                                        <li>
                                            <a href="message.asp">
                                                <i class="fas fa-desktop"></i>Send Form To Applicant</a>
                                        </li>
                                        <li class="has-sub">
                                            <a class="js-arrow" href="#">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive m-b-40">
										  ...
										  <!--  <script type="text/javascript" src="https://rank.formstack.com/forms/js.php/winkersends"></script><noscript><a href="https://rank.formstack.com/forms/winkersends" title="Online Form">Online Form - WINKERSENDS</a></noscript>-->
