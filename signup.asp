...
<html lang="en">
  <head>
    ...
    <title>Register An Account | Winker</title>
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mb-10 text-center">
				...
				<h2>New User Sign Up</h2>
              	...
              	<form action="newuser.asp" method="post" name="userForm">
                <div class="mb-6">
                  <input
				...
				<div class="mb-6">
				 ...
				 <div class="mb-6"name="contactno"id="contactno" >
                  <input
                    type="text"
				...
				<div class="mb-6"name="companyname"id="companyname" >
                  <input
                    type="text"
				...
				<select name ="sector"id="sector"class="
				  ...
				  <option value="" hidden>Select your sector/industry</option>
            <option value = "Legal">Legal</option>
            <option value = "Recruitment">HR/Recruitment</option>
            <option value = "Property">Property/Proptech</option>
			<option value = "Financial">Financial/Fintech</option>
			...
			<option value = "CRA">CRA</option>
				...
				<select name ="users"id="users"class="
				  ...
				  <option value="" hidden>Number of user accounts reqd</option>
			...
			<option value = ">5">>5</option>
              ...
              <p class="text-base text-[#adadad] mb-4">
                By registering an account you agree to adhere with our
                <a
                  href="privacy.html"
              ...
              <p class="text-base text-[#adadad]">
                ...
                <a href="signin.asp" class="text-primary hover:underline">
                  Sign In
                </a>
              </p>
      ...
      <div class="container">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
            <div class="w-full mb-10">
              ...
              <p class="text-base text-[#f3f4fe] mb-7">
                Winker is a game changing subject assessment application designed to reduce delays, manual data processing & risk.
              </p>
          ...
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9">Winker App</h4>
              <ul>
                <li>
                  <a
                    href="index.html"
          ...
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9">Legal</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
